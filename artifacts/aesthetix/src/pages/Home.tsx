          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: isMobile ? 10 : 16 }}>
            ...
            <FadeIn delay={0.15}>
              <div style={{ background: surface, border: `1px solid ${line}`, borderRadius: 14, padding: isMobile ? 14 : 28, display: 'flex', gap: isMobile ? 10 : 16, alignItems: 'flex-start' }}>
                ...
                <div>
                  <h3 style={{ fontFamily: BODY, fontWeight: 500, fontSize: isMobile ? 15 : 16, color: charcoal, margin: isMobile ? '0 0 4px' : '0 0 8px', lineHeight: 1.3 }}>Instagram & TikTok ready</h3>
