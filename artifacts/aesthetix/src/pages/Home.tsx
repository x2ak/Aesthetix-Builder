  ...
  return (
    <div className="bg-[#1A1A1A] min-h-screen text-white font-sans overflow-x-hidden">
        ...
        <div className="max-w-5xl mx-auto px-6 relative z-10">
          ...
          <div className="relative" ref={howRef}>
            ...
            <div className="grid grid-cols-3 gap-3 md:gap-8 relative z-10">
              {[
                { n: "1", title: "Discovery", desc: <span className="text-[#C9A84C]">We learn about your clinic, treatments and what's holding you back.</span> },
                { n: "2", title: "Build",     desc: <span className="text-[#C9A84C]">We design and build your site — tailored to your brand. Delivered in days.</span> },
                { n: "3", title: "Launch",    desc: <span className="text-[#C9A84C]">You go live, take bookings and run on autopilot.</span> },
              ].map(({ n, title, desc }) => (
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="fixed bottom-6 right-6 z-[150] flex items-center justify-center w-14 h-14 rounded-full shadow-lg hover:scale-110 transition-transform duration-200"
        style={{
          background: "#25D366",
