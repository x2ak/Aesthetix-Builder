...
const CONFIGS = {
  ...
  dermadoll: {
    ...
    textLight: '#F7F4EE',
    stats: [
      { label: 'Total Revenue (This Month)', value: '£—', sub: 'Admin credentials pending' },
      ...
      <main style={{ flex: 1, background: cfg.bg, overflowY: 'auto', padding: '28px 32px' }}>
                  ...
                  {[
                    ...
                    <tr key={i}>
                      ...
                      <td style={{ padding: '10px 0', borderBottom: '1px solid #F7F4EE' }}>
                        <span style={{ fontFamily: BODY, fontWeight: 400, fontSize: 9, textTransform: 'uppercase', letterSpacing: '0.1em', color: '#4CAF50', background: '#E8F5E9', borderRadius: 4, padding: '3px 8px' }}>{row.status}</span>
                      </td>
                    </tr>
                  ))}
                </tbody>
        ...
        <div style={{ background: '#fff', borderRadius: 10, border: '1px solid rgba(0,0,0,0.06)', padding: '20px 20px' }}>
          <h2 style={{ fontFamily: BODY, fontWeight: 500, fontSize: 13, color: '#1A1A1C', margin: '0 0 14px' }}>
            This Week — {client === 'starr' ? 'Hornchurch' : 'Availability'} 
          </h2>
